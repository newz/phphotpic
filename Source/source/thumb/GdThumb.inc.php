...
class GdThumb extends ThumbBase
{
	...
	public function writestr ($str)
	{
		...
		$ha =  imagesy($this->workingImage)-13;
		imagestring($this->workingImage,2,4,$ha-1,$str,$b);
		imagestring($this->workingImage,2,2,$ha-1,$str,$b);
		imagestring($this->workingImage,2,3,$ha,$str,$b);
		imagestring($this->workingImage,2,3,$ha-2,$str,$b);
		imagestring($this->workingImage,2,3,$ha-1,$str,$w);
